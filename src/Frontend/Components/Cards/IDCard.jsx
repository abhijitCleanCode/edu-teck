        ...
        {selectedClass && (
          <div className="mt-4">
            ...
            {loading ? (
              ...
              <div className="px-6 py-4 text-left text-black-200">
                No students found
              </div>
            ) : (
              <Table
        ...
        <div className="mb-8">
          ...
          >
            ...
            >
              {/* Organization Logo */}
              <div
                className="w-full absolute flex flex-row"
                style={{ top: "4%", left: "5%" }}
              >
                <img src="/holycross.png" alt="holycross" className="size-8" />
                <span className="ml-2 text-white flex-row items-center text-wrap">
                  Holy Cross
                </span>
              </div>
              ...
              {/* User Details */}
              <div
                className="absolute w-full px-4 text-sm"
                style={{ top: "46%" }}
              >
                <div className="flex justify-between mb-1">
                  <span className="font-medium">Student ID</span>
                  <span>{student?._id || "1234567890"}</span>
                </div>
                <div className="flex justify-between mb-1">
                  <span className="font-medium">Class</span>
                  <span> {selectedClassName || "eg-1A"}</span>
                </div>
                <div className="flex justify-between mb-1">
                  <span className="font-medium">Roll No.</span>
                  <span> {student?.rollNumber || "eg-123"}</span>
                </div>
                <div className="flex justify-between mb-1">
                  <span className="font-medium">DOB</span>
                  <span> {convertISODateToDDMMYY(student?.dob) || "N/A"}</span>
                </div>
                <div className="flex justify-between mb-1">
                ...
                <div className="flex justify-between mb-1">
                  ...
                  <span> {student?.phoneNumber || "+123-456-7890"}</span>
                </div>
                <div className="flex justify-between mb-1">
                  <span className="font-medium">Address</span>
                  <span> {student?.address || "Student Address"}</span>
                </div>
                <div className="flex justify-between mb-1">
              ...
              <div className="absolute w-full bottom-20 right-0 flex flex-row justify-end">
                <span className="right-0 mr-8 font-bold">
                  {" "}
                  Sign. of Principal
                </span>
              </div>
